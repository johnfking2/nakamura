...
public class BasicUserInfoServiceImpl implements BasicUserInfoService {
  ...
  /* MyBerkeley customization: add "major" */
  @Property(value={USER_FIRSTNAME_PROPERTY, USER_LASTNAME_PROPERTY,
      USER_EMAIL_PROPERTY, USER_PICTURE, PREFERRED_NAME, USER_ROLE, USER_DEPARTMENT, USER_COLLEGE, USER_DATEOFBIRTH, USER_TAGS, "major"})
